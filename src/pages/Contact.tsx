...
import { testFirebaseConnection, testContactsCollection } from '@/utils/firebaseTest';
...
export default function Contact() {
  ...
  const handleTestContacts = async () => {
    ...
    const result = await testContactsCollection();
    console.log('Contacts test result:', result);
  };
  ...
  const onSubmit = async (values: ContactFormValues) => {
    ...
    try {
      ...
      const docRef = await addDoc(collection(db, 'contacts_messages'), {
        ...values,
      ...
      if (isFirebaseError(error)) {
        if (error.code === 'permission-denied') {
          ...
          setErrorMessage('Service unavailable. Please check your internet connection.');
        } else if (error.code === 'failed-precondition') {
          setErrorMessage('Database configuration error. Please contact support.');
        } else {
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">info@openstay.com</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">+91 (998) 993-8828</p>
                        </div>
                      </div>
